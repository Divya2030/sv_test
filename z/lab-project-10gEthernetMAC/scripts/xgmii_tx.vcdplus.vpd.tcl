...
# DVE full session
# Saved on Sat Aug 27 21:57:53 2022
# Designs open: 1
#   V1: vcdplus.vpd
...
#<Session mode="Full" path="/home/av00165/lab-project-10gEthernetMAC/scripts/xgmii_tx.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.4} -show_state normal -rect {{0 23} {1279 679}}
...
gui_sg_addsignal -group "$_session_group_13" { testbench.dut.pkt_tx_data testbench.dut.pkt_tx_eop testbench.dut.pkt_tx_mod testbench.dut.pkt_tx_sop testbench.dut.pkt_tx_val testbench.dut.pkt_tx_full }

set _session_group_14 Group2
gui_sg_create "$_session_group_14"
set Group2 "$_session_group_14"

gui_sg_addsignal -group "$_session_group_14" { testbench.dut.pkt_tx_full testbench.dut.pkt_tx_val testbench.dut.pkt_tx_sop testbench.dut.pkt_tx_eop testbench.dut.pkt_tx_mod testbench.dut.pkt_tx_data }
...
gui_sg_addsignal -group "$_session_group_16" { testbench.dut.pkt_rx_avail testbench.dut.pkt_rx_ren testbench.dut.pkt_rx_val testbench.dut.pkt_rx_sop testbench.dut.pkt_rx_eop testbench.dut.pkt_rx_mod testbench.dut.pkt_rx_data }

set _session_group_17 Group5
gui_sg_create "$_session_group_17"
set Group5 "$_session_group_17"

gui_sg_addsignal -group "$_session_group_17" { testbench.dut.clk_xgmii_tx testbench.dut.xgmii_txc testbench.dut.xgmii_txd }
...
catch { gui_list_select -id ${Data.1} {testbench.dut.xgmii_txd }}
...
gui_wv_zoom_timerange -id ${Wave.3} 1148211 1809892
